...
import CardComentary from '@/src/components/Card/Card'; 
import Botton from '@/src/components/Modal/Modal';
...
<div className="flex mt-10 mx-[10vw] justify-center flex-col">
  <div className="grid gap-9 grid-cols-3 justify-center">
        {
